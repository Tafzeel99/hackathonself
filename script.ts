...
form.addEventListener("submit", async (event: Event) => {
    ...
    // Generate share link without photo
...
// Add edit button functionality to edit resume details
...
downloadPdfButton.addEventListener("click", () => {
    if (typeof html2pdf === 'undefined') {
        alert('Error: File is not available to download')
        return;
    }
...
resumePhoto.style.width = "0 auto";
